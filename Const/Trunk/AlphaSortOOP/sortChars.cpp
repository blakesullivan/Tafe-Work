...
bool sortChars::sort(const int iChar1, const int iChar2)
{
...
void sortChars::swap(const int iChar1, const int iChar2) 
{
...
void sortChars::display(const string displayMessage) 
{
	//This function displays the string it is passed.
	cout<<displayMessage;
}

void sortChars::display(const char cChar1, const char cChar2, const char cChar3) 
{
	//This function displays the 3 characters in order and outputs it to a set look
	cout<<cChar1<<", "<<cChar2<<", "<<cChar3<<endl<<endl;
}

void sortChars::set(const int iNum, const char cInputChar, const bool bInput) 
{
...
char sortChars::get(const int iNum, const bool bInput)const 
{
...
bool sortChars::validInput(const char cTemp)
{
...
bool sortChars::replayInput(const char cTemp)
{
	if ('y'==cTemp || 'Y'==cTemp)
	{
		return true;
