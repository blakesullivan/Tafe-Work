//Blake Sullivan - Task 5 - Random Shapes
#include "Shapes.h"
...
int main(int argc, char *argv[]) {
	...
	{	// check for any events from the user or the system
		...
		//Calls the Init method from the Shapes class which will choose and draw the shapes all from here.
		objShape.Init();
