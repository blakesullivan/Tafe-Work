...
void Menu::Init()
{
	...
	bm.AddButton(300, 100, "Splash", 200, 50, cN, cH, cD);
	bm.AddButton(300, 150, "Main Menu", 200, 50, cN, cH, cD);
	bm.AddButton(300, 200, "Options", 200, 50, cN, cH, cD);
	bm.AddButton(300, 250, "Play", 200, 50, cN, cH, cD);
	bm.AddButton(300, 300, "Host", 200, 50, cN, cH, cD);
	bm.AddButton(300, 350, "Join", 200, 50, cN, cH, cD);
	bm.AddButton(300, 400, "Exit", 200, 50, cN, cH, cD);
}
