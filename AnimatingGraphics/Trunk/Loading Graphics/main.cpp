...
int main(int argc, char *argv[]) {
	...
	player = SDL_LoadBMP( "Guard.bmp" ); //Setting the player to point at the image
	...
	{	// check for any events from the user or the system
		...
		sclip.x = iFrame*32; sclip.y = 0; sclip.w = 32; sclip.h = 32; //where the image is  in memory 
		dclip.x = iXloc; dclip.y = iYloc; dclip.w = 32; dclip.h = 32; //where to put the image on screen 
